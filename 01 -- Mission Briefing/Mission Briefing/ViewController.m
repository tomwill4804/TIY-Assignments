...
- (IBAction)authenticateAgent:(UIButton *)sender
{
    ...
    if (self.agentNameTextField.text.length > 0 && self.agentPasswordTextField.text.length > 0)
    {
        ...
        NSString *text = @"This mission will be an arduous one, fraught with peril. You will cover much strange and unfamiliar territory. Should you choose to accept this mission, Agent %@, you will certainly be disavowed, but you will be doing your country a great service. This message will self destruct in 5 seconds.";
        
        self.missionBriefingTextView.text = [text stringByReplacingOccurrencesOfString:@"%@"
                                                                            withString:agentLastName];
